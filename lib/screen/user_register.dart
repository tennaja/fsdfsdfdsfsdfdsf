...
class user_RegisterScreen extends StatefulWidget {
  const user_RegisterScreen({Key? key}) : super(key: key);

  @override
  RegisterScreenState createState() => RegisterScreenState();
}

class RegisterScreenState extends State<user_RegisterScreen> {
                          ...
                          if (fromKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              _usersCollection.doc("${profile.email}").set({
                                ...
                                "user_cart": FieldValue.arrayUnion(list),
                              }).then((value) {
